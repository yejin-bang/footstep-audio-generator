...
from loraw.callbacks import LoRAModelCheckpoint, ReLoRAModelCheckpoint, GradientMonitorCallback
...
def main():
    ...
    # Add gradient monitoring  (ONLY when using LoRA)
    if args.use_lora == 'true':
        callbacks.append(GradientMonitorCallback(lora=lora, log_every_n_steps=10))
    ...
    if args.quantize == 'true':
        ...
        trainer = pl.Trainer(
            ...
            logger=wandb_logger,
            log_every_n_steps=1,
            max_epochs=args.max_epochs if args.max_epochs > 0 else 10000000,
