...
class PoseVideoOverlay:
    def __init__(self, video_path):
        ...
        self.extractor = PoseExtractor(target_fps=30, confidence_threshold=0.7)
    ...
    def _create_frame_mapping(self):
        ...
        print(f"Available keys in pose_result: {list(self.pose_result.keys())}")
    ...
    def draw_pose_overlays(self, frame, frame_number):
        ...
        landmarks = self.pose_result['landmarks_data'][pose_index]
...
if __name__ == "__main__":
    # Video path
    video_file = "/Users/yejinbang/Documents/GitHub/sfx-project/test_videos/walk5.mp4"
